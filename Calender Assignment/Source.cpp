...
//**********************************
//iii.For a given user, print the longest free period; that is, the longest consecutive number of days in which the user has no activity.
void longestFreePeroid(activity***** calender, char user[])
{
	temporary corordinates[30]; int c = 0;
	int check = 0;
